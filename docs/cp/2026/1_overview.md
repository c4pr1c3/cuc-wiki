...
| 阶段 | 时间 | 任务内容 | 产出物 |
| --- | --- | --- | --- |
| **第 1-2 周** | 8 学时 | 选题与需求分析 | 项目选题报告 |
| **第 3-4 周** | 8 学时 | 系统设计与技术调研 | 系统设计文档初稿 |
| **第 5-10 周** | 24 学时 | 核心功能开发（迭代 1-3） | 可运行的原型系统 |
| **第 11-12 周** | 8 学时 | 功能完善与测试 | 完整功能系统 |
| **第 13-14 周** | 8 学时 | 文档编写与演示准备 | 完整文档 + 演示视频 |
| **第 15-16 周** | 8 学时 | 答辩与展示 | 最终答辩 |

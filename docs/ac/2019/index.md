...
* 大作业完成过程请在 Github 上建立小组的公开仓库，每个组员的日常完成进度通过 git 提交历史来体现。
...
[PHP 版实现的课程系统半成品源代码](https://github.com/c4pr1c3/ac-demo) 或 [Python 版实现的课程系统半成品源代码](https://github.com/TheMasterOfMagic/ac) ，
...
* [课程知识回顾与展望](http://sec.cuc.edu.cn/huangwei/course/AppliedCryptographyPractice/2018/Overview.md.html)
* [在应用开发项目中如何安全实现密码学算法](http://sec.cuc.edu.cn/huangwei/course/AppliedCryptographyPractice/2018/Implementation.md.html)
